...
const ORACLE_SIGNATURES: &[BuiltinSignature] = &[
    ...
    BuiltinSignature {
        name: "CONTAINS",
        syntaxes: &[
            "CONTAINS(text_column, text_query [, label])",
        ],
        argument_separator_keywords: &[],
    },
    BuiltinSignature {
    ...
    BuiltinSignature {
        name: "SDO_ELEM_INFO_ARRAY",
        syntaxes: &[
            "SDO_ELEM_INFO_ARRAY(number [, number ]...)",
        ],
        argument_separator_keywords: &[],
    },
    BuiltinSignature {
    ...
    BuiltinSignature {
        name: "SDO_ORDINATE_ARRAY",
        syntaxes: &[
            "SDO_ORDINATE_ARRAY(number [, number ]...)",
        ],
        argument_separator_keywords: &[],
    },
    BuiltinSignature {
