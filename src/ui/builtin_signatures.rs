...
// Sources: Oracle AI Database 26ai SQL Quick Reference, MySQL 8.0
// Reference Manual, and MariaDB Server 12.2 documentation.
...
const ORACLE_SIGNATURES: &[BuiltinSignature] = &[
    ...
    BuiltinSignature {
        name: "JSON_EQUAL",
        syntaxes: &[
            "JSON_EQUAL(json1, json2 [ ALLOW | DISALLOW SCALARS ] [ ERROR | TRUE | FALSE ON ERROR ])",
        ],
        argument_separator_keywords: &[],
    },
    BuiltinSignature {
        name: "JSON_EXISTS",
        syntaxes: &[
            "JSON_EXISTS(expr, path [ PASSING expr AS identifier [, ...] ] [ ERROR | TRUE | FALSE ON ERROR ])",
        ],
        argument_separator_keywords: &[],
    },
    BuiltinSignature {
    ...
    BuiltinSignature {
        ...
        syntaxes: &[
            "STATS_T_TEST_INDEP(expr1, expr2 [, { STATISTIC | ONE_SIDED_SIG | TWO_SIDED_SIG | DF }])",
        ],
        argument_separator_keywords: &[],
    },
    BuiltinSignature {
        ...
        syntaxes: &[
            "STATS_T_TEST_INDEPU(expr1, expr2 [, { STATISTIC | ONE_SIDED_SIG | TWO_SIDED_SIG | DF }])",
        ],
        argument_separator_keywords: &[],
    },
    BuiltinSignature {
        ...
        syntaxes: &[
            "STATS_T_TEST_ONE(expr1 [, expr2] [, { STATISTIC | ONE_SIDED_SIG | TWO_SIDED_SIG | DF }])",
        ],
        argument_separator_keywords: &[],
    },
    BuiltinSignature {
        ...
        syntaxes: &[
            "STATS_T_TEST_PAIRED(expr1, expr2 [, { STATISTIC | ONE_SIDED_SIG | TWO_SIDED_SIG | DF }])",
        ],
        argument_separator_keywords: &[],
    },
    BuiltinSignature {
