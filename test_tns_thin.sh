...
Environment:
  ...
  ORACLE_TEST_SID              optional; copied to ORACLE_THIN_TEST_SID when set
...
export ORACLE_THIN_TEST_SID="${ORACLE_THIN_TEST_SID:-${ORACLE_TEST_SID:-}}"
...
TNS thin live test configuration
  ...
  SID: ${ORACLE_THIN_TEST_SID:-not set}
