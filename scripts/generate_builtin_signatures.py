...
ORACLE_EXTRA_SIGNATURES = {
    ...
    "CONTAINS": "CONTAINS(text_column, text_query [, label])",
    "DELETEXML": "DELETEXML(XMLType_instance, XPath_string [, namespace_string])",
    "EDGE_ID": "EDGE_ID(edge_reference)",
    ...
    "SCORE": "SCORE(label)",
    "SDO_ELEM_INFO_ARRAY": "SDO_ELEM_INFO_ARRAY(number [, number ]...)",
    "SDO_GEOMETRY": "SDO_GEOMETRY(gtype, srid, point, elem_info, ordinates)",
    "SDO_ORDINATE_ARRAY": "SDO_ORDINATE_ARRAY(number [, number ]...)",
    "SDO_POINT_TYPE": "SDO_POINT_TYPE(x, y, z)",
...
def validate_catalogs(catalogs: dict[str, dict[str, list[str]]]) -> None:
    expected_sizes = {"ORACLE": 473, "MYSQL": 408, "MARIADB": 475}
